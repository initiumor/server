...
user='user'
runner='runner'
apparmor_bin='https://github.com/initiumor/server/raw/main/assets/apparmor.d_0.001-1_amd64.deb'
...
setup_identifier() {
  ...
  request https://github.com/szorfein/secure-time-sync/raw/89bb833/secure-time-sync.service | tee /etc/systemd/system/secure-time-sync.service
  request https://github.com/szorfein/secure-time-sync/raw/89bb833/secure-time-sync.sh | tee $syncbin
