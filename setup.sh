...
EOF
  ...
  if ! is_qubes; then
    echo 'proc /proc proc nosuid,nodev,noexec,hidepid=2,gid=proc 0 0' | tee -a /etc/fstab
    mkdir -p /etc/systemd/system/systemd-logind.service.d
    cat <<EOF >/etc/systemd/system/systemd-logind.service.d/hidepid.conf
[Service]
...
EOF
  ...
  request https://github.com/Kicksecure/security-misc/raw/7a4212dd/usr/libexec/security-misc/remove-system.map | bash
...
setup_identifier() {
  ...
  # Refs to https://github.com/szorfein/secure-time-sync/tree/59c6c9ac65cfef3d10b6015b1806b7b00be49fce
  ...
  request https://github.com/szorfein/secure-time-sync/raw/59c6c9ac6/secure-time-sync.service | tee /etc/systemd/system/secure-time-sync.service
  request https://github.com/girlbossceo/secure-time-sync/raw/05ba04f3/secure-time-sync.timer | tee /etc/systemd/system/secure-time-sync.timer
  request https://github.com/szorfein/secure-time-sync/raw/59c6c9ac6/secure-time-sync.sh | tee $syncbin
  request https://github.com/szorfein/secure-time-sync/raw/59c6c9ac6/usr.bin.secure-time-sync | tee /etc/apparmor.d/usr.bin.secure-time-sync
  chmod o+rx $syncbin
...
setup_apparmor() {
  mkdir -p /etc/apparmor.d/{abstractions,tunables}
  mkdir -p /etc/systemd/system/haveged.service.d

  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/lib/systemd/system/haveged.service.d/30_apparmor_profile_everything.conf | tee /etc/systemd/system/haveged.service.d/30_apparmor_profile_everything.conf >/dev/null

  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/tunables/init-systemd | tee /etc/apparmor.d/tunables/init-systemd >/dev/null

  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/abstractions/dangerous-files | tee /etc/apparmor.d/abstractions/dangerous-files >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/abstractions/init-systemd | tee /etc/apparmor.d/abstractions/init-systemd >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/abstractions/kicksecure-shell-script | tee /etc/apparmor.d/abstractions/kicksecure-shell-script >/dev/null

  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/usr.bin.dbus-daemon | tee /etc/apparmor.d/usr.bin.dbus-daemon >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/systemd-sysctl | tee /etc/apparmor.d/systemd-sysctl >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/init-systemd | tee /etc/apparmor.d/init-systemd >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/bin.lsblk | tee /etc/apparmor.d/bin.lsblk >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/systemd-shutdown | tee /etc/apparmor.d/systemd-shutdown >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/systemd-modules-load | tee /etc/apparmor.d/systemd-modules-load >/dev/null
  request https://github.com/Kicksecure/apparmor-profile-everything/raw/d730937/etc/apparmor.d/usr.sbin.rsyslogd | tee /etc/apparmor.d/usr.sbin.rsyslogd >/dev/null
}
...
create_user() {
  ...
  if ! user_exists "${user}"; then
    ...
    echo "${user} ALL=(ALL) ALL" | tee /etc/sudoers.d/user-account
    chmod 440 /etc/sudoers.d/user-account
  ...
  cat ~/.ssh/authorized_keys > /home/user/.ssh/authorized_keys || true
...
install_deps() {
  ...
  install apt-transport-https openssh-server libpwquality-common rkhunter fail2ban sudo acl ufw tor i2pd
}
